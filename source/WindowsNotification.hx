...
class WindowsNotification
{
    ...
    */
    ...
    ')
    #end
    public static function sendWindowsNotification(title:String = '', desc:String = '', res:Int = 0)    // TODO: Linux (found out how to do it so ill do it soon)
    {
        return res;
    }
