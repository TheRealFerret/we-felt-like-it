...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Dapper Husky',		'dapper',			'the guy from simply better than you (not the skinwalker one)\n\n\"Pee pee poo poo, pee poo pee pee\"','https://www.youtube.com/c/dapperhusky','FF6B3E'],
			['Argyll',				'2032',				'May 22, 2032',																	'https://www.youtube.com/@RealArgyll',							'D4DBDD'],
			['geoffry',				'geoffry',			'He knows.',																	'https://www.google.com/search?client=opera-gx&hs=h4h&q=geoffrey&spell=1&sa=X&ved=2ahUKEwiL8ej0zKz9AhUdjIkEHUZ6DcIQBSgAegQIBRAB&biw=1879&bih=949&dpr=1',	'7A7A8C'],
			[''],
			['Psych Engine Team'],
