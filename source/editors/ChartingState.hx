...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Cinematic Bars', "Value 1: How long the cinematic bars stay for (in seconds)\nValue 2: The height of the cinematic bars (default is 200)"],
		['Set Default Cam Zoom', "Value 1: Default Camera Zoom (default is 0.9)"],
		['Screen Flash', "Value 1: Color of the flash (must be lowercase)\nValue 2: How long the flash lasts"],
		['Hud Fade', "Value 1: Hud Alpha\nValue 2: How long the hud fade lasts"],
		['Notes Fade', "Value 1: Notes Alpha\nValue 2: How long the notes fade lasts"],
		['Alternate Attack', "Makes the alternate do it\'s attack. ONLY WORKS ON RUN FOR YOUR LIFE"],
		['Captive Popup', "the dumb popups"],
		['Gaster Popup', "gaster popups"],
		['Fuck Popup', "fuck popups"]
	];
